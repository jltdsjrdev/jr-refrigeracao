# Projeto: Site de Refrigeração

## Descrição
Este projeto é um site de refrigeração desenvolvido para apresentar informações e serviços relacionados à manutenção e instalação de sistemas de refrigeração. O site foi criado com o objetivo de oferecer uma interface amigável para os usuários encontrarem informações úteis sobre o setor e se conectarem com serviços profissionais.

## Funcionalidades do app

- Site criado para divulgação dos serviços prestados da nossa empresa de refrigeração.
- Divulgar nossos meios de comunicação. 
